...
u.accessor = function (f) {
  /* jshint evil: true */
  return f == null || u.isFunction(f)
    ? f
    : u.namedfunc(
        f,
        Function("x", "return x[" + u.field(f).map(u.str).join("][") + "];")
      );
};
...
u.cmp = function (a, b) {
  return (a < b || a == null) && b != null
    ...
    : (a > b || b == null) && a != null
      ? 1
      : ((b = b instanceof Date ? +b : b), (a = a instanceof Date ? +a : a)) !==
            a && b === b
        ? -1
        : b !== b && a === a
          ? 1
...
u.pad = function (s, length, pos, padchar) {
  ...
  switch (pos) {
    ...
    case "center":
      return (
        strrep(Math.floor(d / 2), padchar) +
        s +
        strrep(Math.ceil(d / 2), padchar)
      );
    default:
  ...
  switch (pos) {
    ...
    case "center":
      var l1 = Math.ceil(l / 2),
        l2 = Math.floor(l / 2);
      return (
        (word ? truncateOnWord(s, l1) : s.slice(0, l1)) +
        ellipsis +
