...
//     try {
//       const name = req.query.name; // Example query parameters
//       // ... (other query parameters)
//       const transformedCards = await cardController.fetchAndTransformCardData(
//         name /* other parameters */,
//       );

//       // Respond with URLs or paths as needed
//       res.json({ message: 'Images downloaded for cards', data: transformedCards });
//     } catch (error) {
//       console.error('Error handling download request:', error);
//       res.status(500).send('Failed to handle image download request');
//     }
//   }),
// );
